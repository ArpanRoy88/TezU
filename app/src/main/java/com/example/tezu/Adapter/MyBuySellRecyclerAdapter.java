...
public class MyBuySellRecyclerAdapter extends RecyclerView.Adapter<MyBuySellRecyclerAdapter.ViewHolder> {
   ...
   // private RecyclerViewClickListener listener;
    ...
    public MyBuySellRecyclerAdapter(List<AdUpload> adUploadList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.mybuysell_list_item,parent,false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.togglemenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(context, holder.togglemenu);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.setting:
                                ...
                                FirebaseDatabase.getInstance().getReference().child("AdUploads").child(post.getAdUploadId()).removeValue();
                                break;
                        }
                        return false;
                    }
        ...
        holder.adImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View view_bsl = LayoutInflater.from(context).inflate(R.layout.bottom_sheet_layout_mybuysell,null);
